...
function Header()
{
    ...
    return(
        <div className=" flex items-center justify-between
             ...
             <nav className={`flex items-center gap-7 -mr-0 max-md:mr-0 max-md:absolute max-md:top-full max-md:left-0 max-md:w-full 
...
function Homepage(){
    ...
    function validateform(){
        ...
        if(!firstname.trim()){
            ...
            newerror.firstname="First Name Must Contain Letters Only"
        }
        if(!lastname.trim()){
            newerror.lastname="Last Name is Required"
        }else if(!nameregex.test(lastname)){
            newerror.lastname="Last Name Must Contain Letters Only"
        }
        if(!email.trim()){
        ...
        if(!phone.trim()){
            ...
            newerror.phone="Enter a Valid Phone Number with Country Code"
        }
        seterror(newerror);
    ...
    function updateclient(e) {
        ...
        fetch(`http://localhost:5000/api/quotes/${submitteddata.id}`, {
        method: "PUT",
        ...
        <div className="w-full min-h-screen relative overflow-x-hidden">
            ...
            max-md:pt-[60px] max-md:rounded-[30px] max-md:flex-col">
                <div className="flex-1 min-w-[350px] max-w-[580px] max-md:max-w-full max-md:min-w-0">
                    ...
                    <a href="#contact" className="no-underline py-[15px] px-[30px] rounded-[30px] mt-[-5px] mb-[50px] font-[550] text-[15px]
                    inline-flex items-center gap-3 cursor-pointer bg-[#ee4c1f] border-none text-white hover:bg-[#050523]
                    hover:text-white transition:[background,transform] duration-500 ease-in-out hover:scale-[1.05]">
                ...
                max-md:flex-col max-md:gap-[60px] max-md:mt-[60px]">
                    <div className="group flex-1 flex flex-col items-center box-border">
                        ...
                        <div className="flex justify-center items-center w-[70px]
                            ...
                            max-md:[transform:translateX(0)_scale(1)] max-md:m-[-25px_auto_0_auto] max-md:ml-33
                        ...
                        <h3 className="text-[15px] mt-[10px] font-archivo font-[600]">
                            Michael Chen
                        </h3>
            ...
            <section id="contact" className="qoute  flex w-full px-16 pt-[130px] pb-[120px] box-border gap-[29px] bg-[linear-gradient(135deg,#f15221_5%,#f15221_70%,#ff6a3d_10%,#F4511E_50%,#d63c0e_80%)]
                 ...
                 max-md:px-5 max-md:py-[30px] max-md:min-h-0 max-md:w-full">
                    <form className="flex flex-col gap-5 p-[5px] items-center" onSubmit={isEditing ? updateclient : addclient}>
                        ...
                        <div className="flex gap-[5px] h-[60px] w-full box-border max-md:flex-col max-md:h-auto max-md:gap-3">
                            <div className="flex flex-col p-[2px] mb-[3px]">
                            <input
                                type="text"
                                ...
                                required
                            />
                                {error.firstname && <p className="text-[#ff5c5c] text-[11px] mt-[6px] ml-[5px] leading-none">{error.firstname}</p>}
                            </div>
                            <div className="flex flex-col mb-[3px] p-[2px] ">
                            <input
                                type="text"
                                ...
                                required
                            />
                            {error.lastname && <p className="text-[#ff5c5c] text-[11px] mt-[6px] ml-[5px] leading-none">{error.lastname}</p>}
                            </div>
                        </div>
                            <input
                                type="email"
                                ...
                                required
                            />
                            {error.email && <p className="text-red-400 text-xs mt-[-14px] mb-[-14px] ml-2 ">{error.email}</p>}
                            <input
                                type="tel"
                                ...
                                required
                            />
                            {error.phone && <p className="text-red-400 text-xs mt-[-14px] mb-[-14px] ml-2">{error.phone}</p>}
                            <textarea
